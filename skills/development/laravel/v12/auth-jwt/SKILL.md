---
name: auth-jwt
description: Use this for Laravel v12 token-first authentication where API clients
  authenticate using JWT/Bearer tokens rather than Sanctum SPA sessions.
type: Skill
title: auth-jwt
resource: file:///home/almaruf67/Codes/ai-skills/skills/development/laravel/v12/auth-jwt/SKILL.md
tags:
- development
- laravel
- v12
