---
name: auth-sanctum
description: Use this for Laravel v12 authentication when web clients are SPA frontends
  and should use Sanctum session cookies, with PAT endpoints for mobile/desktop clients.
type: Skill
title: auth-sanctum
resource: file:///home/almaruf67/Codes/ai-skills/skills/development/laravel/v12/auth-sanctum/SKILL.md
tags:
- development
- laravel
- v12
...
# Laravel v12 Authentication (Sanctum)
