---
name: filament-panel
description: Filament v5 panel configuration patterns for Laravel v13. Use this for
  AdminPanelProvider setup, middleware/auth, discovery, and panel-level access rules.
type: Skill
title: filament-panel
resource: file:///home/almaruf67/Codes/ai-skills/skills/development/laravel/v13/filament-panel/SKILL.md
tags:
- development
- laravel
- v13
