...
description: Patterns for defining API routes, versioning, and middleware configuration
  in Laravel v13. Use this for adding or modifying endpoints.
type: Skill
title: laravel-v13-routing
resource: file:///home/almaruf67/Codes/ai-skills/skills/development/laravel/v13/routing/SKILL.md
tags:
- development
- laravel
- v13
...
# Laravel v13 Routing & Middleware

This skill governs the structure and configuration of API routing and middleware in Laravel v13.
