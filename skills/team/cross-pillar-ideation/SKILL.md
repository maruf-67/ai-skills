...
description: 'Detects downstream brand opportunities from any completed work. Use
  when: (1) A project, deployment, or milestone has just been completed, (2) The team
  has published something and wants to know what else it can become, (3) Tawhid has
  written or spoken somewhere and the team should amplify it, (4) A certification
  was renewed or awarded, (5) You want to turn a standalone action into an integrated
  campaign. Triggers on: ''what else can we do with this'', ''what can we publish
  from this'', ''amplify this'', ''cross-pillar'', ''what are we missing'', ''turn
...
added: 2026-03-28
type: Skill
title: cross-pillar-ideation
resource: file:///home/almaruf67/Codes/ai-skills/skills/team/cross-pillar-ideation/SKILL.md
tags:
- team
